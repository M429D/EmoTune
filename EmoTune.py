...
if st.session_state["genre_selected"] == "initial":
    ...
    st.markdown('<div class="key-features">✍🏻️ **Genre Preferences**: Customize your music journey by selecting your preferred instrumental genres for each of the 7 specific emotions, creating a truly personalized touch.\n</div>', unsafe_allow_html=True)
